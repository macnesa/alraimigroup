...
export async function POST(req) {
  ...
  try {
    ...
    const formattedProjectType = projectType?.join(", ") || "Not specified"
      ...
      ">
        ...
        ">
          ...
          <div style="padding:32px">
            ...
            <div>
              ...
              ">
                ...
                <tr>
                  <td style="padding:8px 0;color:#666;width:140px;">Project Type</td>
                  <td style="padding:8px 0;color:#111;">${formattedProjectType}</td>
                </tr>
                ...
                <tr>
                  <td style="padding:8px 0;color:#666;">Brand Stage</td>
                  <td style="padding:8px 0;color:#111;">${brandStage || "-"}</td>
                </tr>
          ...
          ">
            ...
            Sent automatically from alraimigroup.com inquiry form
